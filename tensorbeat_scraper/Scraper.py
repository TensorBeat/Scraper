...
class SoundcloudScraper(ScraperInterface):

    def get_playlists(self, genre : str, scrolls : int) -> list:
        """
...
if __name__ == "__main__":
    scs = SoundcloudScraper()
    playlists = scs.get_playlists("pop", 2)
    print(len(scs.get_songs(playlists, 2)))
